...
def AthLargestElement(array:list,B:int):
    #size of the array.
    ...
    # create a empty min heap and push first bth elements
    l = []
    ...
    for j in range(B,lengthOfArray):
        # if element is greater than min value present in heap.
            #- push the element in heap and pop the min element in heap.
        if array[j] > (l[0]):
